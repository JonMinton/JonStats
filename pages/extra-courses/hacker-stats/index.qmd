...
The GLM Dashboard now has an interactive companion to this whole course — bootstrap the median (a statistic with no analytic standard error), shuffle the two-coins example from this page yourself, line resampling up against Wald and Bayesian intervals, and repair a gamer-skewed sample by post-stratification: [Hacker Stats on the GLM Dashboard](https://stats-board.jonminton.net/hacker-stats/).
