...
I'm not going to look for length-of-stay data; instead I'm going to look at *length-of-teeth*, and the hamster experiment dataset I used in [a previous post](../../../main-course/complete-simulation-example/index.qmd).
