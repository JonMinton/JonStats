...
In this case the intercepts for both series are positive and statistically significant: over the long term, GDP has grown on average around 2% each year, and life expectancy by around 0.28%. As [the blog post this relates to](https://jonminton.github.io/jon-blog/posts/still-the-economy/index.html) makes clear, however, these long-term trends may no longer apply.
