...
Practice choosing the right distribution and link function for different data types with the [GLM Dashboard interactive tutorials](https://stats-board.jonminton.net/).
:::
...
Each family has a default `link` argument, and for this `gaussian` family, this link is the identity function. To see how each of these families works in practice — choosing predictors, link functions, and distributions step-by-step — try the corresponding [GLM Dashboard](https://stats-board.jonminton.net/) tutorials: [Gaussian](https://stats-board.jonminton.net/tutorials/01-gaussian/systematic.html), [Binomial/Logistic](https://stats-board.jonminton.net/tutorials/02-logistic/systematic.html), and [Poisson](https://stats-board.jonminton.net/tutorials/03-poisson/systematic.html).
...
For an interactive companion to this material, the [GLM Dashboard](https://stats-board.jonminton.net/) lets you work through the same framework hands-on — choosing distributions, link functions, and fitting models for different data types.
